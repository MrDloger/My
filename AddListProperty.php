...
$feald->AddField([
	...
	'TYPE' => 'L',
	'LIST' => [
 		//что бы значение элемента типа список создалось, необходимо задать уникальные ключи массива, Bitrix по ключам проверяет наличие уже созданых элементов по этому ID
		'l1' => [
			'VALUE' => 'Yes',
			'DEF' => 'N',
			'XML_ID' => 'Y',
